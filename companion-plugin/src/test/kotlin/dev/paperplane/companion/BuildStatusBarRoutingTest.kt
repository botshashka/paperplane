...
/**
 * Tests the JSON protocol parsing logic used by BuildStatusBar when reading companion-status.json
 * written by the CLI. This validates the contract between CLI and companion without needing a
